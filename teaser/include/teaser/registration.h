 ...
 */
class _declspec(dllexport) ScalarTLSEstimator {
public:
 ...
 */
class _declspec(dllexport) TLSScaleSolver : public AbstractScaleSolver {
public:
 ...
 */
class _declspec(dllexport) ScaleInliersSelector : public AbstractScaleSolver {
public:
 ...
 */
class _declspec(dllexport) GNCRotationSolver : public AbstractRotationSolver {
 ...
 */
class __declspec(dllexport) QuatroSolver : public GNCRotationSolver {
public:
  /**
   * Remove default constructor
   */
