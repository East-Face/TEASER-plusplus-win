...
std::vector<std::pair<int, int>> Matcher::calculateCorrespondences(
    ...
    bool use_crosscheck, bool use_tuple_test, float tuple_scale, int maximum_tuple_count) {
  ...
  advancedMatching(use_crosscheck, use_tuple_test, tuple_scale, maximum_tuple_count);
